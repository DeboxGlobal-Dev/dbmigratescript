                ...
                DB::connection('pgsql')
                    ...
                    ->updateOrInsert(
                        ...
                        [
                            ...
                            'TaxValue' => $user->gstValue ?? 0,
                            'SetDefault' => $user->setDefault ?? 0,
                            'PriceRangeFrom' => $user->priceRangeFrom ?? null,
                            'PriceRangeTo' => $user->priceRangeTo ?? null,  // 🔥 Safe
                            'Currency' => $user->currencyId ?? null,
